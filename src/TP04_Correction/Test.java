...
public class Test {
    ...
    public static void rechercheRecettePlanning(Recette r){
        ...
        for(String key : planning.keySet()){
            ...
            while(it.hasNext())
             ...
             /*
             On peut clairement le faire simplement avec une boucle for :
    ...
    public static void main(String[] args){
        ...
        chargerData("src/TP04_Correction/Ressources/livre1.csv");
        chargerData("src/TP04_Correction/Ressources/livre2.csv");
        afficherLivres();
        genererPlanning();
        afficherPlanning();
        System.out.println("");
